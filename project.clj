(defproject hisproxy "0.1.0-SNAPSHOT"
...
;:env {:repl-port 7001}
  ...
  :ring {:handler hisproxy.handler/app
         :init    hisproxy.handler/init
         :destroy hisproxy.handler/destroy
         :uberwar-name "hisproxy.war"}
  ...
  {:uberjar {:omit-source true
   ...
   :dev {:dependencies [[ring-mock "0.1.5"]
         ...
         :repl-options {:init-ns hisproxy.core}
